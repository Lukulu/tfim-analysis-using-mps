...
'''calculate entanglement entropy S of the ground state depending
   on parameter J/beta for given N and L=N/2'''
...
for i in range(len(J)):
    ...
    s = calc_entanglement_entropy(int(N/2), groundstate)
    x = J[i]/beta[i]
