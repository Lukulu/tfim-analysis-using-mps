...
'''calculate the entanglement entropy S depending on the subsystem size l
   for a different number N of particles and couplings J/beta'''
...
for i in range(len(J)):
    ...
    Lmax = N-1
    for j in range(Lmax):
         S = calc_entanglement_entropy(j, groundstate)
         print("val" + str(i) + " %f %f" % (j, S))
    print("\n")
